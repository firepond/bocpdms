...
class ProbabilityModel:
    ...
    def rescale_DPD_run_length_distribution(
        self, log_scale_new, rescaler_for_old_obs, t
    ):
        ...
        if rescaler_for_old_obs is None:
            ...
            self.joint_log_probabilities[0] = (
                self.joint_log_probabilities[0] - log_scale_new
            )
            self.joint_log_probabilities[1:] = (
                self.joint_log_probabilities[1:] + rescaler_for_old_obs
            )
        self.model_log_evidence = logsumexp(self.joint_log_probabilities)
    ...
    def update_joint_log_probabilities(
        ...
        # CP_log_prob = logsumexp(helper_log_probabilities +
        ...
        if (
            ...
            CP_grad_val, CP_grad_sign = logsumexp(
            ...
            if (
                ...
                joint_log_der_sum, joint_log_der_sum_signs = logsumexp(
                ...
                log_evidence = logsumexp(model_specific_joint_log_probs)
                part1 = (
                    self.model_specific_joint_log_probabilities_derivative
                    - log_evidence
                )
                ...
                rld_der_signs, rld_der = logsumexp(
                ...
                gradient, gradient_signs = logsumexp(
                    a=np.array(
                        [
                            gradients_log_predictive_val[:, 1:]
    ...
    def update_alpha_derivatives(
        ...
        """
        new_derivatives, new_derivatives_sign = logsumexp(
            a=np.array(
                [
        ...
        CP_derivative, CP_derivative_sign = logsumexp(
                ...
                for index, rl_particle in zip(
                    ...
                    if rl_particle < alpha:
                        ...
                        if u <= rl_particle:
                            ...
                            # DEBUG: log sum exp
                            u = logsumexp(np.array([u, alpha, -rl_particle]))
